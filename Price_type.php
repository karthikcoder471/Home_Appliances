...
$product_typeid = $_GET['name'];


if(100==$q)
{
 $i=1;
            $select20="SELECT * FROM products WHERE product_price BETWEEN 100 AND 500 and product_type_id = '$product_typeid'";
...
<?php 
 ...
 $i=1;
            $select20="SELECT * FROM products WHERE product_price BETWEEN 501 AND 1000 and product_type_id = '$product_typeid'";
            $query20=mysqli_query($link,$select20);
...
$i=1;
            $select20="SELECT * FROM products WHERE product_price BETWEEN 1001 AND 5000 and product_type_id = '$product_typeid'";
            $query20=mysqli_query($link,$select20);
...
$i=1;
            $select20="SELECT * FROM products WHERE product_price BETWEEN 5001 AND 10000 and product_type_id = '$product_typeid'";
            $query20=mysqli_query($link,$select20);
...
$i=1;
            $select20="SELECT * FROM products WHERE product_price BETWEEN 10001 AND 20000 and product_type_id = '$product_typeid'";
            $query20=mysqli_query($link,$select20);
