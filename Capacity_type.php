...
{
 $i=1;
            $select20="SELECT * FROM products WHERE capacity BETWEEN 1 AND 5 and product_type_id = '$product_typeid'";
...
<?php 
 ...
 $i=1;
            $select20="SELECT * FROM products WHERE capacity BETWEEN 6.1 AND 10 and product_type_id = '$product_typeid'";
            $query20=mysqli_query($link,$select20);
...
$i=1;
            $select20="SELECT * FROM products WHERE capacity BETWEEN 10.1 AND 20 and product_type_id = '$product_typeid'";
            $query20=mysqli_query($link,$select20);
...
$i=1;
            $select20="SELECT * FROM products WHERE capacity BETWEEN 20.1 AND 30 and product_type_id = '$product_typeid'";
            $query20=mysqli_query($link,$select20);
